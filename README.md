...
4. [Variable-star light curves](Workshop_3_Variable_Star_Light_Curve_Modelling.ipynb): synthetic observations, sinusoidal fitting, residuals, period searches and phase folding.
